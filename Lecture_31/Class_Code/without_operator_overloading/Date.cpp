...
int main(int argc, char** argv, char** envp)
{
   ...
   Date4.IncrementDateDay();
   Date4.Print();
   std::cout<< std::endl;

   Date2.Print();
   Date2.DecrementDateDay();
   Date2.Print();

   std::cout<< std::endl;
   std::cout<< "checking special case" <<std::endl;

   Date3.SetDate(31, MONTH::December, 2022);
   Date4.SetDate(1, MONTH::January, 2023);
   ...
   Date3.IncrementDateDay();
   Date4.DecrementDateDay();
